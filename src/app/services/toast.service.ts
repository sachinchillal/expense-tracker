...
import { Toast, TOAST_TYPE, ToastType } from './ui.interfaces';
...
export class ToastService {
  ...
  showToastAutoError(message: string, body: string, type: ToastType = TOAST_TYPE.ERROR, duration: number = 5000) {
